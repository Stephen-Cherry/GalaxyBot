...
public static class IConfigurationExtensions {
    public static List<string> ValidateBotSecrets(this IConfiguration configuration) {
        ...
        if (GetNullableUInt32(configuration, Constants.BUFF_CHANNEL_ID) == null) invalidSecrets.Add(Constants.BUFF_CHANNEL_ID);
        if (GetNullableUInt32(configuration, Constants.LOG_CHANNEL_ID) == null) invalidSecrets.Add(Constants.LOG_CHANNEL_ID);
